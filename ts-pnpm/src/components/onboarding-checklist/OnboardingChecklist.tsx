...
// import { useGetAccountOnboardingConfig } from '@/lib/hooks/useGetAccountOnboading';
...
// export default function OnboardingChecklist({ session: session }: { session: Session | null }): ReactElement {
//   const { account } = useAccount();
//   const { data, isLoading, isValidating, mutate, error } = useGetAccountOnboardingConfig(account.neosync_account_id, session?.user?.accessToken);
//   const [isOpen, setIsOpen] = useState(false);
//   const [showGuide, setShowGuide] = useState<boolean>(false);
//   const [isSubmitting, setIsSubmitting] = useState<boolean>(false);

//   const onboardingValues: OnboardingValues = data
...
//       setShowGuide(true);
//     }
//   }, [isLoading, isValidating, error, isCompleted, showGuide]);
...
//     if (!account?.neosync_account_id || isSubmitting) {
//       return;
//     }
//     setIsSubmitting(true);
//     try {
//       const resp = await setOnboardingConfig(account.neosync_account_id, {
...
//       mutate(
//         {
//           hasCreatedDestinationConnection: resp.hasCreatedDestinationConnection,
//           hasCreatedSourceConnection: resp.hasCreatedSourceConnection,
//         }
//       );
//       setIsOpen(false);
//     } catch (e) {
