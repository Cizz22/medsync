...
import { JobRunResponse, JobRunStatus as JobRunStatusEnum } from '@/lib/hooks/useGetJobRuns';
...
export function DataTableRowActions<TData>({
  ...
  const run = row.original as JobRunResponse;
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        <DropdownMenuItem
          ...
          onClick={() => router.push(`/dashboard/${account?.neosync_account_id}/runs/${run.id}`)}
        >
          View
        </DropdownMenuItem>
        <DropdownMenuSeparator />
