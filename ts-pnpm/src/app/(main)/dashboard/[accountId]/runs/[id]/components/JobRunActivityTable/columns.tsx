...
import { formatDateTimeMilliseconds } from '@/lib/utils';


import { JobRunEvent, JobRunEventMetadata, JobRunEventTaskError } from '@/lib/hooks/useGetJobRunEvents';
        ...
        return (
          <div className="flex space-x-2">
            <span className="max-w-[500px] truncate font-medium">
                { startTime && formatDateTimeMilliseconds(row.getValue('startTime'))}
            </span>
          </div>
        );
      },
