...
import {
  Table as StickyHeaderTable,
  TableBody,
  TableHead,
  TableHeader,
  TableRow,
} from '@/components/ui/table';
import { LogLevel } from '@/lib/hooks/useGetJobRunLogs';
import { ReloadIcon } from '@radix-ui/react-icons';
import { useVirtualizer } from '@tanstack/react-virtual';
import { useRef } from 'react';


export enum LogLevelInt {
  UNSPECIFIED = 0,  // unspecified log level
      ...
      <div className="flex lg:w-1/2 gap-2 flex-col lg:flex-row">
        ...
        <div className="flex flex-row gap-2 items-center">
          ...
          <div className="flex w-full">
            <Select
              onValueChange={(value) =>
                setSelectedLogLevel(LogLevel[value as keyof typeof LogLevel])
              }
            ...
            >
              ...
              <SelectContent>
                <SelectItem value={LogLevel.UNSPECIFIED}>
                  {'Any'}
                </SelectItem>
