  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="" :class="layoutStore.isRTL ? 'float-end' : 'float-start'">
          <h5 class="mt-3 mb-0">Argon Configurator</h5>
          <p>See our dashboard options.</p>
        </div>
        <div class="mt-4" @click="toggle" :class="layoutStore.isRTL ? 'float-start' : 'float-end'">
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div class="my-2 badge-colors" :class="layoutStore.isRTL ? 'text-end' : ' text-start'">
        ...
        <div class="d-flex gap-2">
          <button id="btn-white" class="btn w-100 px-3 mb-2" :class="layoutStore.sidebarType === 'bg-white'
            ? 'bg-gradient-success'
            : 'btn-outline-success'
            " @click="layoutStore.toggleSidebarColor('bg-white')">
            White
          </button>
          <button id="btn-dark" class="btn w-100 px-3 mb-2" :class="layoutStore.sidebarType === 'bg-default'
            ? 'bg-gradient-success'
            : 'btn-outline-success'
            " @click="layoutStore.toggleSidebarColor('bg-default')">
            Dark
          </button>
        </div>
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="mt-1 form-check-input" :class="layoutStore.isRTL ? 'float-end  me-auto' : ' ms-auto'
              " type="checkbox" id="navbarFixed" :checked="layoutStore.isNavFixed" @click="setNavbarFixed" />
          </div>
        </div>
        ...
        <div class="mt-2 mb-5 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input class="form-check-input mt-1 ms-auto" type="checkbox" :checked="layoutStore.darkMode"
              @click="setDarkMode" />
          </div>
        </div>
...
// layoutStore.sidebarType()
// layoutStore.navbarFixed()
...
const sidenavResponsive = sidenavTypeOnResize
